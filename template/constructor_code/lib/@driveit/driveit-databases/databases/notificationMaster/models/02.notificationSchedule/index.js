...
const tableName = "notificationSchedule";
const modelName = "notificationSchedule";

const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class NotificationSchedule extends Sequelize.Model {
    //schema
    ...
    static searchAll(likeArr, attribute = [], pagination, orderBy, filterArr=[]) {
        ...
        let whereSearch = {};
        let whereFilter = [
            {deleted: false}, ...Utils.filterGenerator(filterArr)]; //for filtering deleted
