...
const tableName = "dealerGroup";
const modelName = "dealerGroup";
...
module.exports = class DealerGroup extends ModelWithPublisher {
    //schema
    ...
    static updateDealerGroup(dealerGroup, where) {
        
            return this.update(dealerGroup, {
                where: where
            });
    }
