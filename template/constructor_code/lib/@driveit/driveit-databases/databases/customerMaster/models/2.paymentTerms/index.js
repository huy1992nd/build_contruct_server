...
const tableName = "paymentTerms";
const modelName = "paymentTerms";
...
module.exports = class PaymentTerms extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'paymentTermsId'});
    }
    //methods
    ...
    static updatePaymentTerms(paymentTerms, where) {
        
            return this.update(paymentTerms, {
                where: where
            });
    }
