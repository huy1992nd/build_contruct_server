...
const tableName = "annualIncome";
const modelName = "annualIncome";
...
module.exports = class AnnualIncome extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'annualIncomeId'});
    }
    ...
    static updateAnnualIncome(annualIncome, where) {
        
            return this.update(annualIncome, {
                where: where
            });
    }
