...
const tableName = "taxclass";
const modelName = "taxclass";
...
module.exports = class TaxClass extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'taxclassId'});
    }
    ...
    static updateTaxClass(taxclass, where) {
        
            return this.update(taxclass, {
                where: where
            });
    }
