...
const tableName = "businessType";
const modelName = "businessType";
...
module.exports = class BusinessType extends Sequelize.Model {
    //schema
    ...
    static updateBusinessType(distributionChannel, where) {
        
            return this.update(distributionChannel, {
                where: where
            });
    }
