...
module.exports = class MaritalStatus extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'MaritalStatusId'});
    }
    ...
    static updateMaritalStatus(maritalStatus, where) {
