...
module.exports = class Industry extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'industryId'});
    }
    ...
    static updateIndustry(industry, where) {
        
            return this.update(industry, {
                where: where
            });
    }
