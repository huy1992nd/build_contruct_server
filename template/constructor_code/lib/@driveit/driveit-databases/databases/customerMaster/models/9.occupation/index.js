...
module.exports = class Occupation extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        // this.myAssociation = this.hasMany(models.Country, {foreignKey: 'occupationId'});
    }
    ...
    static updateOccupation(occupation, where) {
        
            return this.update(occupation, {
                where: where
            });
    }
