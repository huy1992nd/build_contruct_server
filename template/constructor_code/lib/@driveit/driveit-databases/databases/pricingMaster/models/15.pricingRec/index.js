...
const tableName = "pricingRec";
const modelName = "pricingRec";

// const ModelWithPublisher = require('publisher-lib').ModelWithPublisher;
// module.exports = class PricingRec extends ModelWithPublisher {
module.exports = class PricingRec extends Sequelize.Model{
