...
const tableName = "pricingRecKeys";
const modelName = "pricingRecKeys";

// const ModelWithPublisher = require('publisher-lib').ModelWithPublisher;
// module.exports = class PricingRecKeys extends ModelWithPublisher {
module.exports = class PricingRecKeys extends Sequelize.Model{
