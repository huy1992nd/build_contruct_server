...
const tableName = "forecastModelData";
const modelName = "forecastModelData";
...
module.exports = class ForecastModelData extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.ForecastVariantData, {
            foreignKey: 'forecastModelDataId'
        });
    }
