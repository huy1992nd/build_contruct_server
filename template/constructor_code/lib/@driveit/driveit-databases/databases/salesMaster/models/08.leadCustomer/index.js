...
const tableName = "leadCustomer";
const modelName = "leadCustomer";
...
module.exports = class LeadCustomer extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.Lead,{
            foreignKey: 'leadCustId',
            sourceKey: 'id'
        });
        this.myAssociation = this.hasMany(models.LeadVehicleOwn,{
            foreignKey: 'leadCustId',
            sourceKey: 'id'
        });
