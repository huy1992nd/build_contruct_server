...
const tableName = "vehicleBookingTradeInDetail";
const modelName = "vehicleBookingTradeInDetail";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class VehicleBookingTradeInDetail extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.VehicleBooking,{
    ...
    static updateVehicleBookingTradeInDetail(record, where) {
