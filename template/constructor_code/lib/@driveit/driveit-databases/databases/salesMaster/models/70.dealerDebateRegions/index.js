...
const tableName = "dealerDebateRegions";
const modelName = "dealerDebateRegions";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

module.exports = class DealerDebateRegions extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.DealerRebates, { foreignKey: 'dealerRebatesId', targetKey: 'id' });
    }
