...
const tableName = "marginLimitDealerGroup";
const modelName = "marginLimitDealerGroup";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');


// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class MarginLimitDealerGroup extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        ...
        this.myAssociation = this.hasOne(models.MarginLimitDealerValues, { foreignKey: 'dealerGroupTableId', sourceKey: 'id' });
    }
