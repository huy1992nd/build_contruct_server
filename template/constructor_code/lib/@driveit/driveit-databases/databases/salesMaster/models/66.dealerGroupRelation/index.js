...
const tableName = "dealerGroupRelation";
const modelName = "dealerGroupRelation";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

module.exports = class DealerGroupRelation extends Sequelize.Model {
    ...
    static updatDealerGroupRelation(dealerRebatGroups, where) {
