...
const modelName = "vehicleTransferCompulsoryPackageItem";
const tableName = "vehicleTransferCompulsoryPackageItem";
...
module.exports = class VehicleTransferCompulsoryPackageItem extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.VehicleTransfer, {
