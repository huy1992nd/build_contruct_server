...
module.exports = class Forecast extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.ForecastApproval, {
