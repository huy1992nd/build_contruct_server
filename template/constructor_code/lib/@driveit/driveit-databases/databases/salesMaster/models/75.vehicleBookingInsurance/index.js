...
const modelName = "vehicleBookingInsurancePanel";
const tableName = "vehicleBookingInsurancePanel";
...
module.exports = class VehicleBookingInsurance extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.VehicleBooking, {
            foreignKey: 'bookingId', targetKey: 'id'
        });
    }
    ...
    static searchAll(likeArr = [], attributes = null, pagination, orderBy, filterArr = [], skipInclude = false) {
        ...
        let searchAllObj = {
            where: {
                ...where,
                // Table don't have column deleted
                // deleted: {
                //     [Op.not]: true
                // }
            },
