...
const tableName = "documentBranchSeries";
const modelName = "documentBranchSeries";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('publisher-lib').ModelWithPublisher;
module.exports = class DocumentBranchSeries extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.DocumentSeries, {
            foreignKey: 'documentSeriesId',
            sourceKey: 'id'
        })
    ...
    static getBranchCodeByID(id){
        return this.sequelize.query(`SELECT code FROM customer_master.branch WHERE id = ? AND deleted = 0`,{ 
            replacements: [id], type: this.sequelize.QueryTypes.SELECT 
        });
    }
