...
const modelName = "campaignIssuance";
const tableName = "campaignIssuance";
...
module.exports = class CampaignIssuance extends Sequelize.Model {
    //schema
    ...
    static updateCampaignIssuance(campaignIssuance, where) {
        
            return this.update(campaignIssuance, {
                where: where
            });
