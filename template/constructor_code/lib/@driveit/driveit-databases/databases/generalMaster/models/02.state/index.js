...
module.exports = class State extends Sequelize.Model {
    ...
    static associate(models) {
        ...
        this.myAssociation = this.belongsTo(models.Region, {
            foreignKey: 'regionId'
        });
        ...
        this.myAssociation = this.belongsTo(models.AreaOperatorCode, {
            foreignKey: 'areaOperatorCodeId'
        });
    }
    ...
    static updateState(state, where) {
