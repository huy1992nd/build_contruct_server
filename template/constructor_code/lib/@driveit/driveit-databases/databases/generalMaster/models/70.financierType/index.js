...
const tableName = "financierType";
const modelName = "financierType";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

module.exports = class FinancierType extends Sequelize.Model {
    ...
    static updateFinancierType(identity, where) {
