...
const modelName = "materialAccounting";
const tableName = "materialAccounting";
...
module.exports = class MaterialAccounting extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        ...
        this.myAssociation = this.belongsTo(models.Currency, {
            foreignKey: 'accountingCurrrency',
            sourceKey: 'id'
        });
    }
    ...
    static updateMaterialAccounting(materalData, where) {
