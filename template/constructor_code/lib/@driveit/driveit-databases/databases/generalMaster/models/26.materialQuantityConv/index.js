...
const modelName = "quantityConversion";
const tableName = "quantityConversion";
...
module.exports = class MaterialQuantity extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.Uom, {
            foreignKey: 'referenceUom',
            sourceKey: 'id'
        });

        this.myAssociation = this.belongsTo(models.Uom, {
            foreignKey: 'correspondingUom',
            sourceKey: 'id'
        });
    }
    ...
    static updateQuantityConv(materalData, where) {
