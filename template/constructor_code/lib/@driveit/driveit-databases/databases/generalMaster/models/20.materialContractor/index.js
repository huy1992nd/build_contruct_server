...
const modelName = "materialContractor";
const tableName = "materialContractor";
...
module.exports = class MaterialContractor extends Sequelize.Model {
    //schema
    ...
    static updateMaterialContractor(data, where) {
