...
const modelName = "campaignRedemption";
const tableName = "campaignRedemption";
...
module.exports = class CampaignRedemption extends Sequelize.Model {
    //schema
    ...
    static updateCampaignRedemption(basicData, where) {
