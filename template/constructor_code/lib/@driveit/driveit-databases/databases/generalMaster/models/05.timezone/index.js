...
module.exports = class Timezone extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.Country, {
    ...
    static updateTimezone(timezone, where) {
