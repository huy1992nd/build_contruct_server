...
const modelName = "vehicleList";
const tableName = "vehicleList";
...
module.exports = class VehicleList extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.Evoucher, {
    ...
    static updateVehicleList(data, where) {
