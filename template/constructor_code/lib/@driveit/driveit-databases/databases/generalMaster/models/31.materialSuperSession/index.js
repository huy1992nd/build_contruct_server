...
const modelName = "materialSuperSession";
const tableName = "materialSuperSession";
...
module.exports = class MaterialSuperSession extends Sequelize.Model {
    //schema
    ...
    static updateMaterialSuperSession(materalData, where) {
