...
const tableName = "vendorGroup";
const modelName = "vendorGroup";
...
module.exports = class VendorGroup extends Sequelize.Model {
    ...
    static updateVendorGroup(vendorGroup, where) {
        
            return this.update(vendorGroup, {
                where: where
            });
