...
const tableName = "areaOperatorCode";
const modelName = "areaOperatorCode";
...
module.exports = class AreaOperatorCode extends Sequelize.Model {
    ...
    static updateAreaCode(areaOperator, where) {
        
            return this.update(areaOperator, {
                where: where
            });
