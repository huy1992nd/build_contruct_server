...
const modelName = "materialProcurement";
const tableName = "materialProcurement";
...
module.exports = class MaterialProcurement extends Sequelize.Model {
    //schema
    ...
    static updateMaterialProcurement(materalData, where) {
