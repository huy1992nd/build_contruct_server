...
const tableName = "vendorAccountGroup";
const modelName = "vendorAccountGroup";
...
module.exports = class VendorAccountGroup extends Sequelize.Model {
    ...
    static updateVendorAccountGroup(vendorAccountGroup, where) {
        
            return this.update(vendorAccountGroup, {
                where: where
            });
