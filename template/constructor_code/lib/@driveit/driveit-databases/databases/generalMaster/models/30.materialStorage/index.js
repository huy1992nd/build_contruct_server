...
const modelName = "materialStorage";
const tableName = "materialStorage";
...
module.exports = class MaterialStorage extends Sequelize.Model {
    //schema
    ...
    static updateMaterialStorage(materalData, where) {
