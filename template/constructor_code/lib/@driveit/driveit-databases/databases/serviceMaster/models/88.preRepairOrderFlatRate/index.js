...
const tableName = "preRepairOrderFlatRate";
const modelName = "preRepairOrderFlatRate";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class PreRepairOrderFlatRate extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.PreRepairOrder, {
