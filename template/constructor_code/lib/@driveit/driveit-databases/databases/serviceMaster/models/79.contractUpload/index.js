...
const tableName = "contractUpload";
const modelName = "contractUpload";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');
// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;

module.exports = class ContractUpload extends Sequelize.Model {
    ...
    static addRecord(obj, transaction) {
        return this.create(
            obj, {
            returning: true,
            transaction: transaction
    ...
    static updateContractUpload(refund, where, transaction = null) {
        if (transaction === null) {
