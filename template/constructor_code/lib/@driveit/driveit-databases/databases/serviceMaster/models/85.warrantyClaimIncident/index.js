...
const tableName = "warrantyClaimIncident";
const modelName = "warrantyClaimIncident";
...
module.exports = class WarrantyClaimIncident extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.WarrantyClaimIncidentJobs, {
            foreignKey: 'warrantyClaimIncidentId'
        });
        this.myAssociation = this.hasMany(models.WarrantyClaimIncidentParts, {
            foreignKey: 'warrantyClaimIncidentId'
        });
    }
