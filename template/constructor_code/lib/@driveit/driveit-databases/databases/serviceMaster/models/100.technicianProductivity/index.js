...
const tableName = "technicianProductivity";
const modelName = "technicianProductivity";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class TechnicianProductivity extends Sequelize.Model {
