...
const tableName = "splitPart";
const modelName = "splitPart";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');
const customerMaster = require('../../../customerMaster');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class SplitPart extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        ...
        this.myAssociation = this.belongsTo(models.RepairOrderParts, {
            foreignKey: 'repairOrderPartId',
            sourceKey: 'id'
        });
