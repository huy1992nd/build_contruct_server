...
const tableName = "repairOrderPackages";
const modelName = "repairOrderPackages";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class RepairOrderPackages extends Sequelize.Model {
    ...
    static associate(models) {
        ...
        // this.myAssociation = this.belongsTo(models.Parts, {
        //     foreignKey: 'partsId',
        //     targetKey: 'id'
        // });
