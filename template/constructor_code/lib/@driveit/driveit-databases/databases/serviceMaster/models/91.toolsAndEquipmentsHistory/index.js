...
const tableName = "toolsAndEquipmentsHistory";
const modelName = "toolsAndEquipmentsHistory";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

const ToolsAndEquipmentsAttachments = require('../92.toolsAndEquipmentsAttachmentsHistory');
...
module.exports = class ToolsAndEquipments extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.ToolsAndEquipmentsAttachmentsHistory, {
            foreignKey: 'toolsAndEquipmentsHistoryId'
        });
    }
