...
const tableName = "warrantyApprovalParts";
const modelName = "warrantyApprovalParts";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

module.exports = class WarrantyApprovalParts extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        ...
        this.myAssociation = this.belongsTo(models.JobsParts, {
