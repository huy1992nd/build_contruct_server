...
const tableName = "yearlyCalendar";
const modelName = "yearlyCalendar";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');

// const ModelWithPublisher = require('@driveit/publisher-lib').ModelWithPublisher;
module.exports = class YearlyCalendar extends Sequelize.Model {
    ...
    static updateYearlyCalendar(yearlyCalendar, where) {
        return this.update(yearlyCalendar, {
            where: where
        });
    }
