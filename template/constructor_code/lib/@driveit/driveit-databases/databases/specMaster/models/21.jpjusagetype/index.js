...
const tableName = "jpjUsageType";
const modelName = "jpjUsageType";
...
module.exports = class JpjUsageType extends Sequelize.Model {
    ...
    static updateJpjUsageType(model, where) {
