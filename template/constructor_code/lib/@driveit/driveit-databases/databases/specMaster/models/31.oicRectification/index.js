...
const tableName = "oicRectification";
const modelName = "oicRectification";
const Op = Sequelize.Op;
const Utils = require('../../../../utils/database.utils');



module.exports = class OICRectification extends Sequelize.Model {
    ...
    static updateOICRectification(model, where) {
    ...
    static changeStatus(record, where, transaction = null) {
