...
module.exports = class VehicleModel extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.Vehicle, {foreignKey: 'vehicleId', targetKey: 'id'});
        ...
        this.myAssociation = this.belongsTo(models.Variant, {foreignKey: 'variantId', targetKey: 'id'});
        this.myAssociation = this.belongsTo(models.Product, {foreignKey: 'productId', targetKey: 'id'});
    ...
    static updateVehicleModel(model, where) {
