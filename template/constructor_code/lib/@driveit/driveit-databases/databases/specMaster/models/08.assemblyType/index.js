...
const tableName = "assemblyType";
const modelName = "assemblyType";
...
module.exports = class AssemblyType extends Sequelize.Model {
    ...
    static updateAssemblyType(assemblyType, where) {
        
            return this.update(assemblyType, {
                where: where
            });
