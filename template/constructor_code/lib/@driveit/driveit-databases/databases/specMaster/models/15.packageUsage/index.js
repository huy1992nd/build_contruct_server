...
const tableName = "packageUsage";
const modelName = "packageUsage";
...
module.exports = class PackageUsage extends Sequelize.Model {
    //schema
    ...
    static associate(models) {
        this.myAssociation = this.hasMany(models.PackageType, {foreignKey: 'packageUsageId'});
    }
    ...
    static updatePackageUsage(packageUsage, where) {
        
            return this.update(packageUsage, {
                where: where
            });
