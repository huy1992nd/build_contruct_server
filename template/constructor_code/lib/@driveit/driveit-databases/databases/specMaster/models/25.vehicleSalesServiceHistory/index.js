...
const tableName = "vehicleSalesServiceHistory";
const modelName = "vehicleSalesServiceHistory";
...
module.exports = class VehicleSalesServiceHistory extends Sequelize.Model {
    ...
    static associate(models) {
        this.myAssociation = this.belongsTo(models.Vehicle, {
            foreignKey: 'vehicleId', targetKey: 'id'
        });
    ...
    static updateVehicleSalesServiceHistory(model, where) {
