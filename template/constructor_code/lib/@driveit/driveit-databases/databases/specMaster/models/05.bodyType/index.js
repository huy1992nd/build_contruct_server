...
const tableName = "bodyType";
const modelName = "bodyType";
...
module.exports = class BodyType extends Sequelize.Model {
    ...
    static associate(models) {
        ...
        this.myAssociation = this.hasMany(models.Variant, {foreignKey: 'bodyTypeId', sourceKey: 'id'},{onDelete: 'CASCADE'});
    }
    ...
    static updateBodyType(model, where) {
