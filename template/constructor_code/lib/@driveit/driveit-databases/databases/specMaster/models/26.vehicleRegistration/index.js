...
const tableName = "vehicleRegistration";
const modelName = "vehicleRegistration";
...
module.exports = class VehicleRegistration extends Sequelize.Model {
    ...
    static updateVehicleRegistration(model, where) {
