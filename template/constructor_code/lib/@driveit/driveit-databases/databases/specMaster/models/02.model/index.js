...
module.exports = class Model extends ModelWithPublisher {
    ...
    static associate(models) {
        ...
        this.myAssociation = this.hasMany(models.Variant, {foreignKey: 'modelId', sourceKey: 'id'});
        this.myAssociation = this.hasMany(models.Vehicle,{
            foreignKey: 'modelId',
            sourceKey: 'id'
        });
        this.myAssociation = this.hasMany(models.VehicleType,{
            foreignKey: 'modelId',
            sourceKey: 'id'
        });
    }
    ...
    static updateModel(model, where) {
