...
const tableName = "transmissionType";
const modelName = "transmissionType";
...
module.exports = class TransmissionType extends Sequelize.Model {
    ...
    static associate(models) {
        ...
        this.myAssociation = this.hasMany(models.Variant, {foreignKey: 'transmissionTypeId', sourceKey: 'id'},{onDelete: 'CASCADE'});
    }
    ...
    static updateTransmissionType(model, where) {
