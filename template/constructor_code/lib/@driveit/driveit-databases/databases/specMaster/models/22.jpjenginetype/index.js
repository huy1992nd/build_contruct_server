...
const tableName = "jpjEngineType";
const modelName = "jpjEngineType";
...
module.exports = class JpjEngineType extends Sequelize.Model {
    ...
    static updateJpjEngineType(model, where) {
